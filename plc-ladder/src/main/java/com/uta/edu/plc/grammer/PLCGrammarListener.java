...
public interface PLCGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PLCGrammarParser#comment}.
	 * @param ctx the parse tree
	 */
	void enterComment(PLCGrammarParser.CommentContext ctx);
	/**
	 * Exit a parse tree produced by {@link PLCGrammarParser#comment}.
	 * @param ctx the parse tree
	 */
	void exitComment(PLCGrammarParser.CommentContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link PLCGrammarParser#booleanExpression}.
	 * @param ctx the parse tree
	 */
	void enterBooleanExpression(PLCGrammarParser.BooleanExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link PLCGrammarParser#booleanExpression}.
	 * @param ctx the parse tree
	 */
	void exitBooleanExpression(PLCGrammarParser.BooleanExpressionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link PLCGrammarParser#modifier}.
	 * @param ctx the parse tree
	 */
	void enterModifier(PLCGrammarParser.ModifierContext ctx);
	/**
	 * Exit a parse tree produced by {@link PLCGrammarParser#modifier}.
	 * @param ctx the parse tree
	 */
	void exitModifier(PLCGrammarParser.ModifierContext ctx);
}